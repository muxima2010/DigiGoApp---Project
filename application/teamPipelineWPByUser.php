        ...
        <div id="main">
          <div class="inner">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link" href="teamPipelineByUser.php?idTeam=<?php echo $idTeam;?>">Backlog</a>
                </li>
                <li class="nav-item">
            ...
            <?php 
                ...
                $sqlTicketCard = "SELECT * FROM v_ticket_card WHERE status = 'Working Progress' AND idTeam = $idTeam AND idOwner = $idUser ORDER BY idTicket ASC";
